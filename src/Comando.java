 ...
 * usuario. Um comando atualmente consiste em duas strings: uma palavra de
 * comando e uma segunda palavra (por exemplo, se o campo for "pegar mapa",
 * entao as duas strings obviamente serao "pegar" e "mapa").
 * 
 * Isso eh usado assim: comandos ja estao validados como comandos validos Se o
 * usuario entrou um comando invalido (uma palavra que nao eh conhecida) entao o
 * a palavra de comando eh <null>.
 *
...
public class Comando {
     ...
     * 
     * @param primeiraPalavra A primeira palavra do comando. Null se o comando nao
     *                        foi reconhecido
     ...
     * nao foi entendido, o resultado eh null.
     * 
    ...
    /**
     * @return A segunda palavra deste comando. Retorna null se nao existe segunda
     *         palavra.
     */
